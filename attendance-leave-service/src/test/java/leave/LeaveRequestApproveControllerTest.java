...
import et.hrms.controller.leave.impl.LeaveRequestApproveControllerImpl;
...
public class LeaveRequestApproveControllerTest {
  ...
  public void testCreateLeaveRequestApprove() throws Exception {
    ...
    Mockito.doNothing().when(leaveRequestApproveService).createLeaveRequestApprove( anyLong(), anyLong(), any(LeaveRequestApproveDTO.class));
